...
CREATE TABLE IF NOT EXISTS tb_electronic_approval_line_info (
    ...
    arbdec_status VARCHAR(10) NOT NULL,
    repdec_status VARCHAR(10) NOT NULL,
    stage_name VARCHAR(50) NOT NULL,
    muldec_status VARCHAR(10) NOT NULL,
    arrival_at TIMESTAMP NOT NULL,
    exe_at TIMESTAMP NOT NULL,
    option_name VARCHAR(20) NOT NULL,
    open_at TIMESTAMP NOT NULL,
    approval_type VARCHAR(10) NOT NULL,
    last_owner_status VARCHAR(10) NOT NULL,
    order_seq INTEGER NOT NULL,
    last_cnfrmer_status VARCHAR(10) NOT NULL,
    role_name VARCHAR(50),
    sms_send_at1 TIMESTAMP,
    sms_send_at2 TIMESTAMP,
    ok_type VARCHAR(10),
    decide_status VARCHAR(10),
    decide_amt NUMERIC(19,4),
    referencer_view_status VARCHAR(10),
    conn_official_status VARCHAR(10),
    eabus_no VARCHAR(3) NOT NULL,
    ea_exe_id VARCHAR(12) NOT NULL,
    created_by BIGINT,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
