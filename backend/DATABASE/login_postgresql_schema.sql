...
DROP TABLE IF EXISTS tb_group_info CASCADE;
DROP TABLE IF EXISTS mes_role_menu_permission CASCADE;
DROP TABLE IF EXISTS mes_permission_type CASCADE;
DROP TABLE IF EXISTS mes_menu_info CASCADE;
DROP TABLE IF EXISTS mes_group_info CASCADE;
...
VALUES
  ...
  ('PLATFORM_ADMIN', 'MENU_ROLE_MENU', 'PERM_WRITE', 'SYSTEM', 'SYSTEM')
